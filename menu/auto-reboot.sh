...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/AutoFTbot/suprame/main/permission/ip| grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
echo -e "\e[31mDaftar IP dalam Bot Telegram ya #\e[0m"
exit 0
fi
clear 
